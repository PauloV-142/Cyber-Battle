...
### Roadmap
| Semana |	Período |	Etapa / Atividades Previstas | Entregáveis / Marcos |
| ------ | ------ | ------ | ------ |
| Semana 1 |	02/09 a 08/09 |	Formação das equipes (duplas/trios), preenchimento do formulário de proposta, definição do escopo do jogo e arquitetura do site central. |	Formulário de Submissão preenchido. |
| Semana 2 |	09/09 a 15/09 |	Desenvolvimento da estrutura de banco de dados (PHP/MySQL) e layout base da plataforma; prototipação da mecânica principal dos jogos (GDD inicial). |	Protótipo jogável da mecânica básica (Game Loop). |
| Semana 3 |	16/09 a 22/09 |	Integração do front-end do site; implementação de arte, áudio e níveis nos jogos. Pesquisa e aplicação das tecnologias extras pelas equipes. |	Primeira compilação HTML5 funcional do jogo. |
